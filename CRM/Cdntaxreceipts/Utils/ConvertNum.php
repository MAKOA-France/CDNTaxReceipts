...
class CRM_Cdntaxreceipts_Utils_ConvertNum {
    const DEBUG = FALSE;
 ...
 * @example
 * $obj = new CRM_Cdntaxreceipts_Utils_ConvertNum("12345.67", "EUR" );
...
function __construct($nb, $unit){
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "construct : [" . $this->nb . "]";
}
...
private function getThree($group, $unit, $language, $gender){
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>local a [" . $return . "] ";
    // Exceptions.
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>local b $unit [" . $return . "] ";
    // Exceptions de genre.
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>local c [" . $return . "] ";
    return $return;
}
...
private function part($nb, $language, $gender){
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>part a : [" . $return . "]";
    // Exceptions.
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>part b : [" . $return . "]";
...
function convert($language){
    ...
    if (CRM_Cdntaxreceipts_Utils_ConvertNum::DEBUG) echo "<br>";
    return $return;
}
